...
### Example 4: Moving existing General Purpose database to Hyperscale service tier
```
PS C:\>Set-AzSqlDatabase -ResourceGroupName "ResourceGroup01" -DatabaseName "Database01" -Edition "Hyperscale" -RequestedServiceObjectiveName = 'HS_Gen5_2'
ResourceGroupName             : ResourceGroup01
ServerName                    : Server01
DatabaseName                  : Database01
Location                      : Central US
